<?php 
    include_once("inc/config.ing.php");
?>
  ...
  <body>
    <main>
		<div class="register-form">
			<form method="post" id="register" class="m-4">
				<center>
				...
				<div class="input-group">
					...
					<input type="password" class="form-control" id="password2" placeholder="Re-Type your password">
				</div>
